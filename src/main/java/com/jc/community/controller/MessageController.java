...
public class MessageController {
    ...
    public String getLetterList(Model model, Page page){
        ...
        page.setRows(messageService.findConversationCounts(user.getId()));
        // 会话列表
        ...
        if (conversationList != null){
            for (Message message : conversationList) {
                ...
                map.put("unreadCount",messageService.findLetterUnreadCounts(user.getId(), message.getConversationId()));
        ...
        // 查询未读消息数量
        int letterUnrederCount = messageService.findLetterUnreadCounts(user.getId(), null);
        model.addAttribute("letterUnreadCount", letterUnrederCount);
        return "/site/letter";
    }
