...
import com.jc.community.util.RedisKeyUtil;
...
public class LoginController implements CommunityConstant {
    ...
    public String register(Model model, User user){
        ...
        if (map == null || map.isEmpty()){
            model.addAttribute("msg","注册成功，尽快激活");
    ...
    public void getKatpcha(HttpServletResponse response/*, HttpSession session*/){
        ...
        // 将验证码存到redis里
        String redisKey = RedisKeyUtil.getKapechaKey(kaptchaOwner);
    ...
    public String login(String username, String password, String code, Boolean remember,
        ...
        // 检查账号,密码
        int expiredSeconds = remember==null ? REMEMBER_EXPIRED_SECONDS:DEFAULT_EXPIRED_SECONDS;
        System.out.println(expiredSeconds);
        Map<String, Object> map = userService.lonin(username, password, expiredSeconds);
